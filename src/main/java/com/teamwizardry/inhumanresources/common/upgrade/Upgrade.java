...
public class Upgrade
{
    ...
    public Upgrade(String name,int lvl,Upgrade... upgrades)
    {
        this.name = name;
        this.level = lvl;
    ...
    public Upgrade(String name,int level,String... upgrades)
    {
        ...
        {
            incompatibleUpgrades.add(string);
        }
    }
    ...
    public Upgrade addIncompatibleUpgrade(boolean initial, String... upgrades)
    {
        for (String upgrade : upgrades)
        {
            ...
            if (initial && UpgradeRegistry.upgradeMap.containsKey(upgrade))
                UpgradeRegistry.upgradeMap.get(upgrade).addIncompatibleUpgrade(false, this.name);
        }
        return this;
    }
    ...
    public static int getUpgradeLevel(ItemStack item, String name)
    {
        ...
        NBTTagList upgradeList = item.getTagCompound().getTagList("Upgrades", Constants.NBT.TAG_COMPOUND);
